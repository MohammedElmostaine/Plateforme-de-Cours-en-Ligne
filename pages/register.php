    ...
    <div class="min-h-screen flex flex-col">
        ...
        <section
            ...
            <div class="bg-white/10 backdrop-blur-lg rounded-lg p-8 md:shadow-lg w-full max-w-md">
                <h2 class="text-green-400 text-center text-3xl font-semibold mb-6">Register</h2>
                <form method="post" id="registerForm" enctype="multipart/form-data">
                    ...
                    <div class="relative mb-4">
                        ...
                        <input type="email" placeholder="Email" name="email" required
                            class="w-full pl-12 pr-4 py-2 border border-gray-300 rounded-lg bg-white/10 text-gray-600 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-border-green-400" />
                    </div>
                    ...
                    <div class="mb-6 w-full">
                        ...
                        <div class="flex justify-center space-x-4 w-[100%]">
                            <label
                                class="role-option flex items-center justify-center w-[50%] border border-gray-300 rounded-lg cursor-pointer text-gray-300 bg-transparent hover:border-green-400 hover:text-green-400 focus:ring focus:ring-green-400 transition">
                                <input type="radio" name="role" value="Student" class="hidden radio-input" />
                                <span class="font-medium">Student</span>
                            </label>
                            <label
                                class="role-option flex items-center justify-center w-[50%] py-3 border border-gray-300 rounded-lg cursor-pointer text-gray-300 bg-transparent hover:border-green-400 hover:text-green-400 focus:ring focus:ring-green-400 transition">
