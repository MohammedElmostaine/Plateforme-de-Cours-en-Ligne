            ...
            <div class="container mx-auto px-4 ">
                <div class="flex items-center justify-between py-4">
                    ...
                    <nav class="hidden md:flex items-center space-x-6">
                        <a href="../index.php"
                            class="text-green-400 font-bold hover:text-green-500 transition-colors">Home</a>
                        <a href="./courses.php"
        ...
        <section class="hero flex flex-row items-center justify-center mt-24">
            ...
            <div class="flex flex-col justify-start">
                ...
                <div class="flex space-x-4">
                    <a href="../index.php"
                        class="px-6 py-3 bg-green-400 text-white font-semibold rounded-full hover:bg-green-500 transition">
                        Go Back Home
                    </a>
                    <a href="./contact.php"
                        class="px-6 py-3 bg-white border border-green-400 text-green-400 font-semibold rounded-full  hover:bg-green-400 hover:text-white transition">
                        Contact Support
                    </a>
                </div>
            </div>
