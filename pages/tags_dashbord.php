        ...
        <aside class="w-64 bg-gray-900 text-white">
            <div class="p-4">
                ...
                <nav class="space-y-1">
                    ...
                    <a href="./tags_dashbord.php" class="flex items-center gap-3 px-3 py-2 text-sm text-green-400 rounded-md bg-gray-800">
        ...
        <header class="bg-white border-b p-4">
                <div class="flex items-center justify-between max-w-7xl mx-auto">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <button class="bg-green-50 text-green-600 px-4 py-2 rounded-md text-sm font-medium">Search
                            </button>
            ...
            <div class="p-6 max-w-7xl mx-auto">
                <div class="bg-white rounded-lg shadow-sm mb-6 border">
                    <form action="add_tag.php" method="POST" class="flex items-center gap-4 p-6">
                        ...
                        <button type="submit" class="bg-green-500 text-white p-2 px-4 rounded-lg hover:bg-green-600">
                            Add Tag
                        </button>
                    </form>
                </div>
