        ...
        <div class="max-w-6xl mx-auto">
            <div class="text-center mb-12">
                <h2 class="text-4xl font-bold mb-4">
                    Explore Top Courses
                    <span
                        class="bg-gradient-to-r from-green-600 to-green-300 bg-clip-text text-transparent">Categories</span>
                </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div
                    class="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100 hover:border-green-400 hover:scale-105 transition-transform duration-300">
                    <div class="flex items-center gap-4">
                        <div class="p-3 bg-green-400 text-white rounded-lg">
    ...
    <section>
        <div class="py-10 md:px-12 px-6">
            <h2 class="text-4xl font-bold text-gray-800 mb-6 text-center md:mb-11">
                Explore Our <span
                    class="text-gradient bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-green-600">Courses</span>
            </h2>
                        ...
                        <div
                            ...
                            <div class="py-3">
                                ...
                                <div class="flex items-center justify-between mt-3">
                                    <p class="text-green-400 font-bold"><?= htmlspecialchars($course['price']); ?> $</p>
        ...
        <div class="py-10 md:px-12 px-6">
            <div class="flex flex-wrap justify-center items-center mb-12 text-center">
                <h2 class="text-3xl font-bold text-gray-800">
                    FAQs About <span
                        class="text-gradient bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-green-600">Youdemy
                        Platform</span>
                </h2>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                <div class="border border-green-400 rounded-lg p-4 shadow-sm hover:shadow-md transition">
                    <button onclick="toggleAnswer(this)"
                        ...
                        <i class="ri-arrow-down-s-line text-green-400"></i>
                    </button>
                    <div
